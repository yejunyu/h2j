...
public interface IStringBuffer {
    ...
    void delete(int start) throws IndexIsNegativeException, IndexIsOutofRangeException; //从开始位置删除剩下的
    void delete(int start,int end) throws IndexIsNegativeException, IndexIsOutofRangeException; //从开始位置删除结束位置-1
    void reverse(); //反转
    int length(); //返回长度
}
